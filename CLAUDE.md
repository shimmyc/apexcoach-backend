...
- **Deferred to a follow-up in this same session (report-first, NOT built):** AI-rec exercise-name linking (Job 2 — freeform-string name resolution) and wger variations (Job 3 — schema + seed + a "Variations" section in the detail view). Approaches reported for approval before implementing; see ROADMAP.md §7.
